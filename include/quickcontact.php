...
if( isset( $_POST['quick-contact-form-submit'] ) AND $_POST['quick-contact-form-submit'] == 'submit' ) {
    if( $_POST['quick-contact-form-name'] != '' AND $_POST['quick-contact-form-email'] != '' AND $_POST['quick-contact-form-message'] != '' ) {
        ...
        $subject = 'New Message from MoveQB';

        $botcheck = $_POST['quick-contact-form-botcheck'];

        $toemail = 'bonny.lai@gmai@gmail.com'; // Your Email Address
        ...
        if( $botcheck == '' ) {
            ...
            if( $sendEmail == true ):
                ...
                echo 'Email <strong>could not</strong> be sent due to Unexpected Error. Please Try Again later.<br /><br /><strong>Reason:</strong><br />' . $mail->ErrorInfo . '';
            endif;
        } else {
